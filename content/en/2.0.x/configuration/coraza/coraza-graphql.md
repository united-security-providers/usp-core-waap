...
(This section assumes you have read the section [What is Coraza?](coraza/#what-is-coraza))
...
* GraphQL related settings are at `spec.coraza.graphql` and
  ...
  in the [API Reference](../crd-doc/#corewaapservicespeccoraza).
...
* Regarding size limits,
  see also the section [Large Payloads](../../operation/large-payloads.md).
* To use auto-learning,
  it is recommended to first use GraphQL in mode DETECT,
  and then auto-learn using the [Auto-Learning CLI](../../operation/autolearning.md)
