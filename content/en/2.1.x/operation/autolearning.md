...
the respective feature in mode `DETECT` (see [CRS](../configuration/coraza/coraza-crs.md) and
[GraphQL](../configuration/coraza/coraza-graphql.md)) and then learn from the resulting logs:
