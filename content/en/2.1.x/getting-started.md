...
> [!TIP]
> The steps below use the latest Helm chart version: **2.1.1**.
...
> [requestRuleException](crd-doc/#corewaapservicespeccorazacrsrequestruleexceptionsindex) so legitimate basket checkouts
