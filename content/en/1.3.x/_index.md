...
* Current Helm charts version for USP Core WAAP operator : [1.3.0](helm-CHANGELOG.md)
    * Current USP Core WAAP operator release version: [1.2.0](operator-CHANGELOG.md)
    * Current Core WAAP image: [v1.3.0](waap-CHANGELOG.md)
        * Current extProc ICAP image: [1.0.0](ext-proc-icap-CHANGELOG.md)
        * Current extProc OpenAPI image: [0.0.6](ext-proc-openapi-CHANGELOG.md)
