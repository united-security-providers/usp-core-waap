...
|---|---|---|---|
| operator.config | object | `{"waapSpecDefaults":{"image":"uspregistry.azurecr.io/usp/core/waap/usp-core-waap","metrics":{"image":"uspregistry.azurecr.io/usp/core/waap/usp-core-waap-metrics","version":"0.0.1"},"version":"1.3.0"},"waapSpecTrafficProcessingDefaults":{"icap":{"image":"uspregistry.azurecr.io/usp/core/waap/usp-core-waap-ext-proc-icap","version":"1.0.0"},"openapi":{"image":"uspregistry.azurecr.io/usp/core/waap/usp-core-waap-ext-proc-openapi","version":"0.0.6"}},"watchedNamespaces":[]}` | Settings for operator config |
| operator.config.waapSpecDefaults | object | `{"image":"uspregistry.azurecr.io/usp/core/waap/usp-core-waap","metrics":{"image":"uspregistry.azurecr.io/usp/core/waap/usp-core-waap-metrics","version":"0.0.1"},"version":"1.3.0"}` | *Optional*: operation defaults, see field 'operation' in the Core WAAP CRD for possible settings and merge behavior |
...
| operator.version | string | `"1.2.0"` | Version of operator to deploy |
