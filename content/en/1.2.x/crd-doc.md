...
<table>
    ...
    <tbody><tr>
        ...
        <td>object</td>
        <td>
          OWASP Core Rule Set (CRS) settings (version 4.3.0)<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>[]string</td>
        <td>
          References to traffic processing; processing order is OpenAPI, ICAP  (and within each type in the order listed under trafficProcessing)<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>[]enum</td>
        <td>
          Set of request rule classes (default is to include all rules, rules REQUEST_901_INITIALIZATION and REQUEST_949_BLOCKING_EVALUATION are always included, see https://github.com/coreruleset/coreruleset/tree/v4.3.0/rules for all configurable values, just replace '-' by '_' and omit '.conf')<br/>
          <br/>
        ...
        <td>[]enum</td>
        <td>
          Set of response rule classes (default is to include no rules, rules RESPONSE_959_BLOCKING_EVALUATION and RESPONSE_980_CORRELATION are always included, see https://github.com/coreruleset/coreruleset/tree/v4.3.0/rules for all configurable values, just replace '-' by '_' and omit '.conf')<br/>
          <br/>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>
          ...
          <br/>
            <i>Enum</i>: critical, debug, error, info, off, trace, warning<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
